...
#  atoms2.translate((-5+shift)*unit)
  ...
  atoms2.write('atoms2.xyz')
  Natoms = atoms2.get_number_of_atoms()

  types_atoms = set(atoms2.get_chemical_symbols())
  Ntyp = len(types_atoms)


  cell33 = atoms2.get_cell()
