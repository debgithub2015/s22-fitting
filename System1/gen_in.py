...
#  atoms_ref.center()
  ...
  ref_filename1 = "/deac/thonhauserGrp/chakrad/calculations/database-calc/s22x5/xyz_files/s%02d_%02d.xyz"%(NUM,i+1)
   
  atoms_ref1 = io.read(ref_filename1)

  atoms_ref1.set_cell(cell)
     
  positions1 = atoms_ref1.get_positions()
  
  atoms_ref1.center()

  atoms1 = atoms_ref1[0:split]
  atoms2 = atoms_ref1[split:]
