...
#  print Num,'\t', '1','\t',(E0[0] - E0A - E0B )*Ryd,'\t','2','\t', (E0[1] - E0A - E0B )*Ryd,'\t','3','\t', (E0[2] - E0A - E0B )*Ryd, '\t', '4','\t',(E0[3] - E0A - E0B )*Ryd,'\t', '5','\t', (E0[4] - E0A - E0B )*Ryd,'6','\t', (E0[5] - E0A - E0B )*Ryd, '7','\t', (E0[6] - E0A - E0B )*Ryd,'8','\t', (E0[7] - E0A - E0B )*Ryd
     print Num+1,'\t', i,'\t', (E0[i] - E0A[i] - E0B[i] )*Ryd
...
#print Etot_graph_bi, Etxcscf_graph_bi
...
#print Etot_graph_mono, Etxcscf_graph_mono
...
#print Etxcnscf_graph_mono

Eval_graph_mono=Etot_graph_mono-Etxcscf_graph_mono+Etxcnscf_graph_mono 

#print Eval_graph_mono
...
#print Enlc_graph_mono
 
E0_graph_mono = Eval_graph_mono - Enlc_graph_mono

#print E0_graph_mono

print "Graphite", '\t', (E0_graph_bi/2 - E0_graph_mono)*Ryd
